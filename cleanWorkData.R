...
write.csv(workLocationsSA1,"workLocationsSA1.csv",row.names=F)
...
write.csv(distanceMatrixIndex,"distanceMatrixIndex.csv",row.names=F)
...
write.csv(distanceMatrixIndexWork,"distanceMatrixIndexWork.csv",row.names=F)
...
saveRDS(distanceMatrixInt,"distanceMatrixBins.rds")
...
saveRDS(distanceMatrixWork,"distanceMatrixWork.rds")
